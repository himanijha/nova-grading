...
export default function SettingsClient({ me, graders, stats }) {
  ...
  return (
    <div className="page">
      ...
      <p className="sub">
        {me.isAdmin
          ? "Your password, the grader roster, and how far along the grading is."
          : "Your account."}
      </p>

      <PasswordCard grader={me} />

      {/* Everything below is the admin's job: the roster, and the numbers that
          say whether the pile is getting read. */}
      {me.isAdmin && (
        <>
        <div className="card">
          <h3>Progress</h3>
